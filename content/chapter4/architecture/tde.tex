...
It is the technique for reconstructing the underlying dynamics of the time series by transforming a signal into a higher order dimensional state space representation. The TDE is a vector defined as: 
\begin{equation}
