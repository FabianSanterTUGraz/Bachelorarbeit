...
To reuse the code these initialization steps can be integrated directly. Only the delay parameter tau and the window size has to be adapted following the recommendations evaluated in the evaluation section(hier noch ref hinzufügen das kapitel gibt es noch nicht).