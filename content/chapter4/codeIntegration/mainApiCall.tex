 ...
 To offer modular software integration, the complete time delay embedding, sliding window and component analysis pipeline is exposed through a single API function. This function directly takes the data containers detailed in the section \ref{section:dataContainers}.
 \lstinputlisting[
  language=C,
