...
\end{equation}
Once the running mean which is an pointer that can be assessed across functions the tde vector is centered 
\begin{equation}
...
\end{equation}
Data centering translates the coordinate system origin to the sample mean vector $\mu_t$. This ensures that the resulting covariance matrix accurately captures variance relative to the centroid, rather than second-moment distortions introduced by a non-zero mean offset.
