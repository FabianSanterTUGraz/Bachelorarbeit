...
\\ \\
To ensure that the eigenvectors signs don't get flipped by 180 degree and keep their original directions a copy of the original eigenvector is taken which is later used to touch up if necessary. 
\begin{equation}
