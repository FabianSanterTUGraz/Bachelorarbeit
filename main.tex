...
%% general metadata:
\newcommand{\myauthor}{Fabian Santer}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Real-time Anomaly Detection in Time Series Data}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubject}{SUBJECT}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{KEYWORDS}  %% also used for PDF metadata (hyperref)

%% this information is used only for generating the title page:
\newcommand{\myworktitle}{Bachelor's Thesis}  %% official type of work like ``Bachelor theses''
...
\newcommand{\mydegreeprogramme}{Bachelor's degree programme : Software Engineering and Management \mystudy} %% Master's or PhD degree programme
...
\newcommand{\myinstitute}{Institute of Visual Computing} %% affiliation
\newcommand{\myinstitutehead}{Univ.-Prof. Dipl.-Ing. Dr.techn. Thomas Pock} %% head of institute
\newcommand{\mysupervisor}{Dipl.-Math. Dr.techn. Ullrich Torsten} %% your supervisor
\newcommand{\mycosupervisors}{}
\newcommand{\myevaluator}{Prof.~Some Genius} %% your evaluator
\newcommand{\myhomestreet}{Aufkirchen 37} %% your home street (with house number)
\newcommand{\myhometown}{Toblach} %% your home town
\newcommand{\myhomepostalnumber}{39034} %% your postal number of home town
\newcommand{\mysubmissionmonth}{month} %% month you are handing in
\newcommand{\mysubmissionyear}{year} %% year you are handing in
\newcommand{\mysubmissiontown}{Graz} %% town of handing in (or \myhometown)

%% additional information for generic_documentation title page
\newcommand{\myid}{12230815} %% Matrikelnummer
...
%%listings package for clean code integration
\usepackage{color}
\usepackage{listings}
